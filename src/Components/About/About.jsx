  ...
  return (
    <div className="about">
      ...
      <div className="about-right">
        ...
        <p>
          Embark on transformative educational journer with our university's
        ...
        <p>
          with focus on innovation, hands on learning and personalised
          mentorship, our students are equipped to make a meaningful impact in
          the world.
        </p>
        <p>
